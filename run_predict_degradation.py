...
if __name__ == "__main__":
    main()
##--model_type dna --tokenizer_name=dna5 --model_name_or_path ./model_pretrain/5-new-12w-0 --task_name dnaprom --do_train --do_eval --data_dir data/5 --max_seq_length 201 --per_gpu_eval_batch_size=32 --per_gpu_train_batch_size=32 --learning_rate 1e-5 --num_train_epochs 20 --output_dir output/5/ --evaluate_during_training --logging_steps 100 --save_steps 4000 --warmup_percent 0.1 --hidden_dropout_prob 0.1 --overwrite_output --weight_decay 0.01 --n_process 1
##--model_type dna --tokenizer_name=dna5 --model_name_or_path ./output5_pretrain/checkpoint-5500 --task_name dnaprom --do_train --do_eval --data_dir data/5 --max_seq_length 512 --per_gpu_eval_batch_size=32 --per_gpu_train_batch_size=32 --learning_rate 1e-5 --num_train_epochs 20 --output_dir output/5/ --evaluate_during_training --logging_steps 100 --save_steps 4000 --warmup_percent 0.1 --hidden_dropout_prob 0.1 --overwrite_output --weight_decay 0.01 --n_process 1
